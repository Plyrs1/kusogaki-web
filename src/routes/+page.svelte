...
/>
<div class="fixed grid right-0 justify-items-end">
  {#each data.announcementLists as announcementList, index}
    <a href={announcementList.url}><AnnounceBar message={announcementList.title} isDark={index !== 0} /></a>
  {/each}
</div>
